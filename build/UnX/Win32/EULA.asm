...
CONST	SEGMENT
$SG129299 DB	'W', 00H, 'A', 00H, 'V', 00H, 'E', 00H, 00H, 00H
$SG129302 DB	00H
$SG129305 DB	00H
$SG129384 DB	'%ws Software License Agreement', 00H
$SG129441 DB	00H
$SG129388 DB	'EULA_Body', 00H
$SG129442 DB	00H
$SG129458 DB	00H
$SG129387 DB	'Use of this software is granted on the condition that an'
	...
	DB	' holders.', 0aH, 00H
	ORG $+3
$SG129389 DB	'EULA_Inset', 00H
	ORG $+1
$SG129391 DB	'Overview of Products Unlicensed', 00H
$SG129392 DB	'Overview of Products Licensed', 00H
	ORG $+2
$SG129393 DB	'%s', 00H
	ORG $+1
$SG129395 DB	'7-Zip', 00H
	ORG $+2
$SG129396 DB	'%s', 00H
	ORG $+1
$SG129398 DB	'ADL', 00H
$SG129399 DB	'%s', 00H
	ORG $+1
$SG129401 DB	'CEGUI (D3D9/11/GL)', 00H
	ORG $+1
$SG129402 DB	'%s', 00H
	ORG $+1
$SG129405 DB	'DirectXTex (D3D11/12)', 00H
	ORG $+2
$SG129406 DB	'%s', 00H
	ORG $+1
$SG129408 DB	'FreeType 2', 00H
	ORG $+1
$SG129409 DB	'%s', 00H
	ORG $+1
$SG129411 DB	'GLEW (OpenGL)', 00H
	ORG $+2
$SG129412 DB	'%s', 00H
	ORG $+1
$SG129414 DB	'GLM v 0.9.4.5', 00H
	ORG $+2
$SG129415 DB	'%s', 00H
	ORG $+1
$SG129417 DB	'ImGui', 00H
	ORG $+2
$SG129418 DB	'%s', 00H
	ORG $+1
$SG129420 DB	'MinHook', 00H
$SG129421 DB	'%s', 00H
	ORG $+1
$SG129423 DB	'NvAPI', 00H
	ORG $+2
$SG129424 DB	'%s', 00H
	ORG $+1
$SG129426 DB	'PCRE', 00H
	ORG $+3
$SG129427 DB	'%s', 00H
	ORG $+1
$SG129428 DB	'%s', 00H
	ORG $+1
$SG129430 DB	'Special K', 00H
	ORG $+2
$SG129431 DB	'%s', 00H
	ORG $+1
$SG129433 DB	'STB', 00H
$SG129434 DB	'%s', 00H
	ORG $+1
$SG129436 DB	'Vulkan', 00H
	ORG $+1
$SG129437 DB	'%s', 00H
	ORG $+1
$SG129439 DB	'ZLIB', 00H
	ORG $+3
$SG129440 DB	'%s', 00H
	ORG $+1
$SG129444 DB	' Decline ', 00H
	ORG $+2
$SG129446 DB	'WARNING:  ', 00H
	ORG $+1
$SG129447 DB	'Game will exit!', 00H
$SG129449 DB	'I agree ... never show me this again!', 00H
	ORG $+2
$SG129451 DB	' Accept ', 00H
	ORG $+3
$SG129453 DB	'S', 00H, 'p', 00H, 'e', 00H, 'c', 00H, 'i', 00H, 'a', 00H
	DB	'l', 00H, 'K', 00H, 00H, 00H
	ORG $+2
$SG129455 DB	'Read the Yellow Text', 00H
	ORG $+3
$SG129456 DB	'Please use the other button, you already broke the terms'
	DB	'.', 00H
	ORG $+2
$SG129457 DB	'You may be able to find a modified version with these te'
	DB	'rms removed', 00H
	ORG $+4
$SG129459 DB	'The authors listed above are not responsible for said mo'
...
; 176  :     if (ImGui::CollapsingHeader (pirate ? "Overview of Products Unlicensed" : 
	...
	mov	ecx, OFFSET $SG129392
	test	bl, bl
	mov	eax, OFFSET $SG129391
	cmove	eax, ecx
	push	0
	push	eax
...
; 193  :     if (config.apis.ADL.enable && ImGui::CollapsingHeader ("ADL"))
	...
	cmp	BYTE PTR ?config@@3Usk_config_t@@A+809, 0

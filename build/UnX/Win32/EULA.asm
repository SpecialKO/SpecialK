...
CONST	SEGMENT
$SG129294 DB	'W', 00H, 'A', 00H, 'V', 00H, 'E', 00H, 00H, 00H
$SG129297 DB	00H
$SG129300 DB	00H
$SG129379 DB	'%ws Software License Agreement', 00H
$SG129436 DB	00H
$SG129383 DB	'EULA_Body', 00H
$SG129437 DB	00H
$SG129453 DB	00H
$SG129382 DB	'Use of this software is granted on the condition that an'
	...
	DB	' holders.', 0aH, 00H
	ORG $+3
$SG129384 DB	'EULA_Inset', 00H
	ORG $+1
$SG129386 DB	'Overview of Products Unlicensed', 00H
$SG129387 DB	'Overview of Products Licensed', 00H
	ORG $+2
$SG129388 DB	'%s', 00H
	ORG $+1
$SG129390 DB	'7-Zip', 00H
	ORG $+2
$SG129391 DB	'%s', 00H
	ORG $+1
$SG129393 DB	'ADL', 00H
$SG129394 DB	'%s', 00H
	ORG $+1
$SG129396 DB	'CEGUI (D3D9/11/GL)', 00H
	ORG $+1
$SG129397 DB	'%s', 00H
	ORG $+1
$SG129400 DB	'DirectXTex (D3D11/12)', 00H
	ORG $+2
$SG129401 DB	'%s', 00H
	ORG $+1
$SG129403 DB	'FreeType 2', 00H
	ORG $+1
$SG129404 DB	'%s', 00H
	ORG $+1
$SG129406 DB	'GLEW (OpenGL)', 00H
	ORG $+2
$SG129407 DB	'%s', 00H
	ORG $+1
$SG129409 DB	'GLM v 0.9.4.5', 00H
	ORG $+2
$SG129410 DB	'%s', 00H
	ORG $+1
$SG129412 DB	'ImGui', 00H
	ORG $+2
$SG129413 DB	'%s', 00H
	ORG $+1
$SG129415 DB	'MinHook', 00H
$SG129416 DB	'%s', 00H
	ORG $+1
$SG129418 DB	'NvAPI', 00H
	ORG $+2
$SG129419 DB	'%s', 00H
	ORG $+1
$SG129421 DB	'PCRE', 00H
	ORG $+3
$SG129422 DB	'%s', 00H
	ORG $+1
$SG129423 DB	'%s', 00H
	ORG $+1
$SG129425 DB	'Special K', 00H
	ORG $+2
$SG129426 DB	'%s', 00H
	ORG $+1
$SG129428 DB	'STB', 00H
$SG129429 DB	'%s', 00H
	ORG $+1
$SG129431 DB	'Vulkan', 00H
	ORG $+1
$SG129432 DB	'%s', 00H
	ORG $+1
$SG129434 DB	'ZLIB', 00H
	ORG $+3
$SG129435 DB	'%s', 00H
	ORG $+1
$SG129439 DB	' Decline ', 00H
	ORG $+2
$SG129441 DB	'WARNING:  ', 00H
	ORG $+1
$SG129442 DB	'Game will exit!', 00H
$SG129444 DB	'I agree ... never show me this again!', 00H
	ORG $+2
$SG129446 DB	' Accept ', 00H
	ORG $+3
$SG129448 DB	'S', 00H, 'p', 00H, 'e', 00H, 'c', 00H, 'i', 00H, 'a', 00H
	DB	'l', 00H, 'K', 00H, 00H, 00H
	ORG $+2
$SG129450 DB	'Read the Yellow Text', 00H
	ORG $+3
$SG129451 DB	'Please use the other button, you already broke the terms'
	DB	'.', 00H
	ORG $+2
$SG129452 DB	'You may be able to find a modified version with these te'
	DB	'rms removed', 00H
	ORG $+4
$SG129454 DB	'The authors listed above are not responsible for said mo'
...
; 176  :     if (ImGui::CollapsingHeader (pirate ? "Overview of Products Unlicensed" : 
	...
	mov	ecx, OFFSET $SG129387
	test	bl, bl
	mov	eax, OFFSET $SG129386
	cmove	eax, ecx
	push	0
	push	eax

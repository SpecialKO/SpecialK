...
static ID3D12PipelineState*         g_pPipelineState        = nullptr;
static DXGI_FORMAT                  g_RTVFormat             = DXGI_FORMAT_UNKNOWN;
static ID3D12Resource*              g_pFontTextureResource  = nullptr;
...
void ImGui_ImplDX12_RenderDrawData(ImDrawData* draw_data, ID3D12GraphicsCommandList* ctx)
{
  ...
  // Setup render state
  static const float
    blend_factor [4] = { 0.f, 0.f, 0.f, 0.f };
...
ImGui_ImplDX12_CreateDeviceObjects (void)
{
  ...
  // Create the vertex shader
  {
    ...
    static D3D12_INPUT_ELEMENT_DESC local_layout[] = {
      ...
      { "COLOR",    0, DXGI_FORMAT_R8G8B8A8_UNORM, 0, static_cast<UINT>((size_t)(&((ImDrawVert*)0)->col)), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
    };
  ...
  // Create the pixel shader
  {
    ...
    D3DCompile ( pixelShader, strlen (pixelShader),
                   NULL, NULL, NULL,
                     "main", "ps_5_0",
                       0, 0,
    ...
    psoDesc.PS = {
      g_pPixelShaderBlob->GetBufferPointer (),
...
ImGui_ImplDX12_InvalidateDeviceObjects (void)
{
  ...
  if (g_pFontTextureResource) { g_pFontTextureResource->Release (); g_pFontTextureResource = NULL; ImGui::GetIO ().Fonts->TexID = NULL; }

...
{
  return SK_D3D9_DispatchPresent_Device ( pReal, pSourceRect, pDestRect,
...
HRESULT STDMETHODCALLTYPE IWrapDirect3DDevice9::GetDisplayModeEx(UINT iSwapChain, D3DDISPLAYMODEEX *pMode, D3DDISPLAYROTATION *pRotation)
{
  ...
  return static_cast <IDirect3DSwapChain9Ex *>(implicit_swapchain_)->GetDisplayModeEx (pMode, pRotation);
}

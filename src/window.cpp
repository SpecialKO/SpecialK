...
void SK_Window_SetTopMost (bool bTop, bool bBringToTop = false, HWND hWnd = game_window.hWnd);
                 ...
                 bool active = false )
{
  ...
  if (game_window.active && state_changed)
  {
    // Engage fullscreen
  ...
  else if ((! game_window.active) && state_changed)
  {

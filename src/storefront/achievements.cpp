                                                  ...
                                                  void*                stats_ )
{
  ...
  galaxy::api::IStats_1_152_1* stats = (galaxy::api::IStats_1_152_1 *)stats_;
  ...
  stats->GetAchievementDisplayNameCopy (szName, display_name,  511);
  stats->GetAchievementDescriptionCopy (szName, desc,         4095);
  ...
  hidden_ = !stats->IsAchievementVisibleWhileLocked (szName);

  uint32_t                                  time;
  stats->GetAchievement (szName, unlocked_, time);

...
public:
   ...
   */
  auto get_method( const char * name_, int argc = 0 ) const -> Method *
  {
    if ( Il2cpp::get_method == nullptr )
      return nullptr;

    auto method = Il2cpp::get_method( this, name_, argc );
    if ( !method )
      return nullptr;
   ...
   */
  auto get_field( const char * name_ ) const -> Field *
  {
    if ( Il2cpp::get_field == nullptr )
      return nullptr;

    auto field = Il2cpp::get_field( this, name_ );
    if ( !field )
      return nullptr;
   ...
   */
  auto get_nested_class( const char * name_ ) const -> Class *
  {

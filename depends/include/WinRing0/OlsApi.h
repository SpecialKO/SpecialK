...
typedef BOOL (WINAPI *InitializeOls_pfn)(void);
               extern InitializeOls_pfn InitializeOls;
...
//	BYTE regAddress		// Configuration Address 0-255
//);
typedef DWORD (WINAPI *ReadPciConfigDword_pfn)(DWORD,BYTE);
                extern ReadPciConfigDword_pfn ReadPciConfigDword;
...
//	DWORD value			// Write Value
//);
typedef VOID (WINAPI *WritePciConfigDword_pfn)(DWORD,BYTE,DWORD);
               extern WritePciConfigDword_pfn
                      WritePciConfigDword;

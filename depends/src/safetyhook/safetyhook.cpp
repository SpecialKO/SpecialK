#pragma warning(disable:26447) // This code analysis warning is being applied during normal compilation in newer toolchains (MSVC 17.14) for some unknown reason
#pragma warning(disable:4834)  // [[nodiscard]] attribute has not been applied, ignore it
...
public:
    ...
    TrapManager() { m_trap_veh = SK_AddVectoredExceptionHandler(1, trap_handler); }
    ~TrapManager() {

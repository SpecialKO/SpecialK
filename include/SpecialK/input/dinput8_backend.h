...
using LPCDICONSTANTFORCE = const DICONSTANTFORCE *;

typedef struct DIRAMPFORCE {
    LONG  lStart;
    LONG  lEnd;
} DIRAMPFORCE, *LPDIRAMPFORCE;
using LPCDIRAMPFORCE = const DIRAMPFORCE *;
...
using LPCDIPERIODIC = const DIPERIODIC *;
...
using LPCDICONDITION = const DICONDITION *;
...
using LPCDICUSTOMFORCE = const DICUSTOMFORCE *;
...
using LPCDIEFFECT_DX5 = const DIEFFECT_DX5 *;
...
using DIEFFECT_DX6 = DIEFFECT;
using LPDIEFFECT_DX6 = LPDIEFFECT;
...
using LPDIENUMEFFECTSINFILECALLBACK = BOOL (FAR PASCAL *)(LPCDIFILEEFFECT , LPVOID);
#endif /* DIJ_RINGZERO */
...
using LPDIRECTINPUTEFFECT = struct IDirectInputEffect *;
...
#else
using DIACTION = DIACTIONA;
using LPDIACTION = LPDIACTIONA;
#endif // UNICODE

using LPCDIACTIONA = const DIACTIONA *;
using LPCDIACTIONW = const DIACTIONW *;
#ifdef UNICODE
typedef DIACTIONW DIACTION;
typedef LPCDIACTIONW LPCDIACTION;
#else
using DIACTION = DIACTIONA;
using LPCDIACTION = LPCDIACTIONA;
#endif // UNICODE
using LPCDIACTION = const DIACTION *;
...
#else
using DIACTIONFORMAT = DIACTIONFORMATA;
using LPDIACTIONFORMAT = LPDIACTIONFORMATA;
#endif // UNICODE
using LPCDIACTIONFORMATA = const DIACTIONFORMATA *;
using LPCDIACTIONFORMATW = const DIACTIONFORMATW *;
#ifdef UNICODE
typedef DIACTIONFORMATW DIACTIONFORMAT;
typedef LPCDIACTIONFORMATW LPCDIACTIONFORMAT;
#else
using DIACTIONFORMAT = DIACTIONFORMATA;
using LPCDIACTIONFORMAT = LPCDIACTIONFORMATA;
#endif // UNICODE
using LPCDIACTIONFORMAT = const DIACTIONFORMAT *;
...
using LPCDICOLORSET = const DICOLORSET *;
...
#else
using DICONFIGUREDEVICESPARAMS = DICONFIGUREDEVICESPARAMSA;
using LPDICONFIGUREDEVICESPARAMS = LPDICONFIGUREDEVICESPARAMSA;
#endif // UNICODE
using LPCDICONFIGUREDEVICESPARAMSA = const DICONFIGUREDEVICESPARAMSA *;
using LPCDICONFIGUREDEVICESPARAMSW = const DICONFIGUREDEVICESPARAMSW *;
#ifdef UNICODE
typedef DICONFIGUREDEVICESPARAMSW DICONFIGUREDEVICESPARAMS;
typedef LPCDICONFIGUREDEVICESPARAMSW LPCDICONFIGUREDEVICESPARAMS;
#else
using DICONFIGUREDEVICESPARAMS = DICONFIGUREDEVICESPARAMSA;
using LPCDICONFIGUREDEVICESPARAMS = LPCDICONFIGUREDEVICESPARAMSA;
#endif // UNICODE
using LPCDICONFIGUREDEVICESPARAMS = const DICONFIGUREDEVICESPARAMS *;
...
#else
using DIDEVICEIMAGEINFO = DIDEVICEIMAGEINFOA;
using LPDIDEVICEIMAGEINFO = LPDIDEVICEIMAGEINFOA;
#endif // UNICODE
using LPCDIDEVICEIMAGEINFOA = const DIDEVICEIMAGEINFOA *;
using LPCDIDEVICEIMAGEINFOW = const DIDEVICEIMAGEINFOW *;
#ifdef UNICODE
typedef DIDEVICEIMAGEINFOW DIDEVICEIMAGEINFO;
typedef LPCDIDEVICEIMAGEINFOW LPCDIDEVICEIMAGEINFO;
#else
using DIDEVICEIMAGEINFO = DIDEVICEIMAGEINFOA;
using LPCDIDEVICEIMAGEINFO = LPCDIDEVICEIMAGEINFOA;
#endif // UNICODE
using LPCDIDEVICEIMAGEINFO = const DIDEVICEIMAGEINFO *;
...
#else
using DIDEVICEIMAGEINFOHEADER = DIDEVICEIMAGEINFOHEADERA;
...
using LPCDIDEVICEIMAGEINFOHEADERW = const DIDEVICEIMAGEINFOHEADERW *;
#ifdef UNICODE
typedef DIDEVICEIMAGEINFOHEADERW DIDEVICEIMAGEINFOHEADER;
typedef LPCDIDEVICEIMAGEINFOHEADERW LPCDIDEVICEIMAGEINFOHEADER;
#else
using DIDEVICEIMAGEINFOHEADER = DIDEVICEIMAGEINFOHEADERA;
using LPCDIDEVICEIMAGEINFOHEADER = LPCDIDEVICEIMAGEINFOHEADERA;
#endif // UNICODE
using LPCDIDEVICEIMAGEINFOHEADER = const DIDEVICEIMAGEINFOHEADER *;
...
#else
using DIDEVICEOBJECTINSTANCE_DX3 = DIDEVICEOBJECTINSTANCE_DX3A;
using LPDIDEVICEOBJECTINSTANCE_DX3 = LPDIDEVICEOBJECTINSTANCE_DX3A;
#endif // UNICODE
using LPCDIDEVICEOBJECTINSTANCE_DX3A = const DIDEVICEOBJECTINSTANCE_DX3A *;
using LPCDIDEVICEOBJECTINSTANCE_DX3W = const DIDEVICEOBJECTINSTANCE_DX3W *;
using LPCDIDEVICEOBJECTINSTANCE_DX3 = const DIDEVICEOBJECTINSTANCE_DX3  *;
#endif /* DIRECTINPUT_VERSION >= 0x0500 */
...
using LPCDIDEVICEOBJECTINSTANCEW = const DIDEVICEOBJECTINSTANCEW *;
using LPCDIDEVICEOBJECTINSTANCE = const DIDEVICEOBJECTINSTANCE  *;

using LPDIENUMDEVICEOBJECTSCALLBACKA = BOOL (FAR PASCAL *)(LPCDIDEVICEOBJECTINSTANCEA, LPVOID);
using LPDIENUMDEVICEOBJECTSCALLBACKW = BOOL (FAR PASCAL *)(LPCDIDEVICEOBJECTINSTANCEW, LPVOID);
#ifdef UNICODE
...
using LPCDIPROPDWORD = const DIPROPDWORD *;
...
using LPCDIPROPPOINTER = const DIPROPPOINTER *;
#endif /* DIRECTINPUT_VERSION >= 0x0800 */
...
using LPCDIPROPRANGE = const DIPROPRANGE *;
...
using LPCDIPROPCAL = const DIPROPCAL *;
...
using LPCDIPROPCALPOV = const DIPROPCALPOV *;
...
using LPCDIPROPGUIDANDPATH = const DIPROPGUIDANDPATH *;

typedef struct DIPROPSTRING {
    DIPROPHEADER diph;
    WCHAR   wsz[MAX_PATH];
} DIPROPSTRING, *LPDIPROPSTRING;
using LPCDIPROPSTRING = const DIPROPSTRING *;
...
using LPCDIPROPCPOINTS = const DIPROPCPOINTS *;
#endif /* DIRECTINPUT_VERSION >= 0x0800 */
...
using LPCDIDEVICEOBJECTDATA_DX = const DIDEVICEOBJECTDATA_DX3 *;
...
#else
using DIDEVICEINSTANCE_DX3 = DIDEVICEINSTANCE_DX3A;
using LPDIDEVICEINSTANCE_DX3 = LPDIDEVICEINSTANCE_DX3A;
#endif // UNICODE
using LPCDIDEVICEINSTANCE_DX3A = const DIDEVICEINSTANCE_DX3A *;
using LPCDIDEVICEINSTANCE_DX3W = const DIDEVICEINSTANCE_DX3W *;
using LPCDIDEVICEINSTANCE_DX3 = const DIDEVICEINSTANCE_DX3  *;
#endif /* DIRECTINPUT_VERSION >= 0x0500 */
...
using LPCDIDEVICEINSTANCEW = const DIDEVICEINSTANCEW *;
#ifdef UNICODE
typedef DIDEVICEINSTANCEW DIDEVICEINSTANCE;
typedef LPCDIDEVICEINSTANCEW LPCDIDEVICEINSTANCE;
#else
using DIDEVICEINSTANCE = DIDEVICEINSTANCEA;
using LPCDIDEVICEINSTANCE = LPCDIDEVICEINSTANCEA;
#endif // UNICODE
...
using LPDIRECTINPUTDEVICEW = struct IDirectInputDeviceW *;
...
using LPDIRECTINPUTDEVICEA = struct IDirectInputDeviceA *;
...
#endif
using LPDIRECTINPUTDEVICE = struct IDirectInputDevice *;
...
using LPCDIEFFECTINFOW = const DIEFFECTINFOW *;
using LPCDIEFFECTINFO = const DIEFFECTINFO  *;

#define DISDD_CONTINUE          0x00000001

using LPDIENUMEFFECTSCALLBACKA = BOOL (FAR PASCAL *)(LPCDIEFFECTINFOA, LPVOID);
using LPDIENUMEFFECTSCALLBACKW = BOOL (FAR PASCAL *)(LPCDIEFFECTINFOW, LPVOID);
#ifdef UNICODE
#define LPDIENUMEFFECTSCALLBACK  LPDIENUMEFFECTSCALLBACKW
#else
#define LPDIENUMEFFECTSCALLBACK  LPDIENUMEFFECTSCALLBACKA
#endif // !UNICODE
using LPDIENUMCREATEDEFFECTOBJECTSCALLBACK = BOOL (FAR PASCAL *)(LPDIRECTINPUTEFFECT, LPVOID);
...
using LPDIRECTINPUTDEVICE2W = struct IDirectInputDevice2W *;
...
using LPDIRECTINPUTDEVICE2A = struct IDirectInputDevice2A *;
...
#endif
using LPDIRECTINPUTDEVICE2 = struct IDirectInputDevice2 *;
...
using LPDIRECTINPUTDEVICE7W = struct IDirectInputDevice7W *;
...
using LPDIRECTINPUTDEVICE7A = struct IDirectInputDevice7A *;
...
#endif
using LPDIRECTINPUTDEVICE7 = struct IDirectInputDevice7 *;
...
using LPDIRECTINPUTDEVICE8W = struct IDirectInputDevice8W *;
...
using LPDIRECTINPUTDEVICE8A = struct IDirectInputDevice8A *;
...
#endif
using LPDIRECTINPUTDEVICE8 = struct IDirectInputDevice8 *;
...
using LPDIENUMDEVICESCALLBACKA = BOOL (FAR PASCAL *)(LPCDIDEVICEINSTANCEA, LPVOID);
using LPDIENUMDEVICESCALLBACKW = BOOL (FAR PASCAL *)(LPCDIDEVICEINSTANCEW, LPVOID);
#ifdef UNICODE
#define LPDIENUMDEVICESCALLBACK  LPDIENUMDEVICESCALLBACKW
#else
#define LPDIENUMDEVICESCALLBACK  LPDIENUMDEVICESCALLBACKA
#endif // !UNICODE
using LPDICONFIGUREDEVICESCALLBACK = BOOL (FAR PASCAL *)(IUnknown FAR *, LPVOID);
...
#if(DIRECTINPUT_VERSION >= 0x0800)
using LPDIENUMDEVICESBYSEMANTICSCBA = BOOL (FAR PASCAL *)(LPCDIDEVICEINSTANCEA, LPDIRECTINPUTDEVICE8A, DWORD, DWORD, LPVOID);
using LPDIENUMDEVICESBYSEMANTICSCBW = BOOL (FAR PASCAL *)(LPCDIDEVICEINSTANCEW, LPDIRECTINPUTDEVICE8W, DWORD, DWORD, LPVOID);
#ifdef UNICODE
...
using LPDIRECTINPUTW = struct IDirectInputW *;
...
using LPDIRECTINPUTA = struct IDirectInputA *;
...
#endif
using LPDIRECTINPUT = struct IDirectInput *;
...
using LPDIRECTINPUT2W = struct IDirectInput2W *;
...
using LPDIRECTINPUT2A = struct IDirectInput2A *;
...
#endif
using LPDIRECTINPUT2 = struct IDirectInput2 *;
...
using LPDIRECTINPUT7W = struct IDirectInput7W *;
...
using LPDIRECTINPUT7A = struct IDirectInput7A *;
...
#endif
using LPDIRECTINPUT7 = struct IDirectInput7 *;
...
using LPDIRECTINPUT8W = struct IDirectInput8W *;
...
using LPDIRECTINPUT8A = struct IDirectInput8A *;
...
using LPFNSHOWJOYCPL = void (WINAPI*)( HWND hWnd );
#endif

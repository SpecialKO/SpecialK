...
struct ImDrawList
{
    ...
    inline    void  PrimWriteVtx(const ImVec2& pos, const ImVec2& uv, const ImVec4& col) { _VtxWritePtr->pos = pos; _VtxWritePtr->uv = uv; _VtxWritePtr->col = col; _VtxWritePtr++; _VtxCurrentIdx++; }
